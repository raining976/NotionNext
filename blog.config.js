...
const BLOG = {
    ...
    NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'cfb7de96ecf64f80bdc47d47f0246367',
    ...
    GREETING_WORDS: 'process.env.NEXT_PUBLIC_GREETING_WORDS || 宽宥疲敝和风雨，做自渡之舟, 欢迎来到🌧️的小世界～🎉',

    CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Raining', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || '平平无奇的睡觉大王', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.raining976.top', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'running.zhang@foxmail.com', // 邮箱地址 例如mail@tangly1024.com
    CONTACT_WEIBO: '',
    CONTACT_TWITTER: '',// 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/yogurt-alpaca', // 你的github个人主页 例如 https://github.com/tangly1024
    ...
    POST_SHARE_BAR_ENABLE: 'false', // 文章分享功能 ，将在底部显示一个分享条
    POSTS_SHARE_SERVICES: 'link', // 分享的服務，按顺序显示,逗号隔开
    ...
    COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://comment.raining976.top', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
    ...
    // 作废配置
    AVATAR: '', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
